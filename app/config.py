...
class Settings(BaseSettings):
    ...
    ALLOWED_ORIGINS: list[str] = ["http://localhost:3000", "http://localhost:5173", "http://localhost:5500", "http://127.0.0.1:5500", "https://chelseymiguel.github.io", "https://episodicmagazine.org", "https://www.episodicmagazine.org"]
